...
const renderGellery = ()=>{
    const pictures = (0, _galleryItemsJs.galleryItems).map(({ preview , original , description  })=>{
...
const galleryItemsMarkup = renderGellery((0, _galleryItemsJs.galleryItems));
...
},{}],"kaxSc":[function() {},{}]},["9VJAZ","6XVkV"], "6XVkV", "parcelRequire6350")
